...
from roar.collections.tts.models import SimplyFastCodecTTS
from roar.core.config import hydra_runner
from roar.utils import logging
from roar.utils.exp_manager import exp_manager


@hydra_runner(config_path="conf/simply_fast_codec_tts", config_name="sfct_24000_align")
def main(cfg):
    ...
    model = SimplyFastCodecTTS(cfg=cfg.model, trainer=trainer)
