...
from roar.collections.tts.models import JETSPromptModel
from roar.core.config import hydra_runner
from roar.utils import logging
from roar.utils.exp_manager import exp_manager


@hydra_runner(config_path="conf/jets_sp", config_name="jets_24000_align")
def main(cfg):
    ...
    model = JETSPromptModel(cfg=cfg.model, trainer=trainer)
