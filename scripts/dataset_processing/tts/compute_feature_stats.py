...
$ python <roar_root_path>/scripts/dataset_processing/tts/compute_feature_stats.py \
...
def main():
    ...
    for manifest_path, audio_dir, feature_dir in zip(
        manifest_paths, audio_dirs, feature_dirs
    ):
