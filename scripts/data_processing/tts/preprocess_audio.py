...
$ python <roar_root_path>/scripts/dataset_processing/tts/preprocess_audio.py \
    ...
    --num_workers=1 \
    --trim_config_path="<roar_root_path>/examples/tts/conf/trim/energy.yaml" \
...
from roar.collections.asr.parts.utils.manifest_utils import (
    read_manifest,
    write_manifest,
)
from roar.collections.tts.parts.preprocessing.audio_trimming import AudioTrimmer
...
def get_args():
    ...
    parser.add_argument(
        ...
        required=False,
        type=Path,
        help="Path to config file for roar.collections.tts.data.audio_trimming.AudioTrimmer",
    )
    parser.add_argument(
        "--max_entries",
        default=0,
