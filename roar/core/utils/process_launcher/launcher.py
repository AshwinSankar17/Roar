...
class ProcessLauncherConfig:
    _target_: str = "roar.core.utils.process_launcher.launcher.ProcessLauncher"
    num_gpus: int = -1
    jobs_per_gpu: int = 1
...
ConfigStore.instance().store(
    group="hydra/launcher", name="roar_launcher", node=ProcessLauncherConfig, provider="roar_process_launcher",
)
