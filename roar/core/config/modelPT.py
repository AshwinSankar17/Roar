...
from roar.core import config
from roar.core.classes.dataset import DatasetConfig
from roar.utils import exp_manager


#Change docstrings for all functions and classes.
...
@dataclass
class RoarConfig: # TODO: Change the name, ext and behaviour of this
    name: str = MISSING
...
class ModelConfigBuilder: 
    def __init__(self, model_cfg: ModelConfig):
        ...
        builds a finalized ModelConfig that can be supplied to a RoarModel dataclass as
        the `model` component.
        ...
        Example:
            ...
            model = roar.<domain>.models.<ModelName>Model(cfg=model_config, trainer=Trainer())
