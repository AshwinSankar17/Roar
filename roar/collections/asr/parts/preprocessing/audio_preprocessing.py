...
from roar.collections.tts.parts.submodules.spectr_augment import SpecAugment, SpecCutout
from roar.core.classes import Exportable, NeuralModule, typecheck
...
from roar.core.utils import numba_utils
from roar.core.utils.numba_utils import __NUMBA_MINIMUM_VERSION__
...
class AudioToMelSpectrogramPreprocessorConfig:
    _target_: str = "roar.collections.asr.modules.AudioToMelSpectrogramPreprocessor"
...
class AudioToMFCCPreprocessorConfig:
    _target_: str = "roar.collections.asr.modules.AudioToMFCCPreprocessor"
    sample_rate: int = 16000
    window_size: float = 0.02
    window_stride: float = 0.01
    n_window_size: Optional[int] = None
...
class SpectrogramAugmentationConfig:
    _target_: str = "roar.collections.asr.modules.SpectrogramAugmentation"
    freq_masks: int = 0
    time_masks: int = 0
    freq_width: int = 0
...
class CropOrPadSpectrogramAugmentationConfig:
    audio_length: int
    _target_: str = "roar.collections.asr.modules.CropOrPadSpectrogramAugmentation"
...
class MaskedPatchAugmentationConfig:
    ...
    freq_masks: int = 0
    freq_width: int = 0
    _target_: str = "roar.collections.asr.modules.MaskedPatchAugmentation"
