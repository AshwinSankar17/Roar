...
from roar.core.classes import Typing, typecheck
from roar.core.neural_types import LengthsType, NeuralType, SpectrogramType
...
class SpecAugmentNumba(nn.Module, Typing):
    ...
    def __init__(
        ...
        if self.rng is not None:
            logging.warning(
                "`rng` was supplied to SpecAugmentNumba, but it is not used."
            )
