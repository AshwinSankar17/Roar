...
class _AudioTextDataset(Dataset):
    ...
    Args:
        ...
        augmentor (roar.collections.tts.parts.perturb.AudioAugmentor): An AudioAugmentor object used to augment loaded
            audio
        max_duration: If audio exceeds this length, do not include in dataset
        min_duration: If audio is less than this length, do not include in dataset
        max_utts: Limit number of utterances
    ...
    def __init__(
        ...
        augmentor: "roar.collections.tts.parts.perturb.AudioAugmentor" = None,
...
class AudioToCharDataset(_AudioTextDataset):
    ...
    Args:
        ...
        sample_rate (int): Sample rate to resample loaded audio to
        int_values (bool): If true, load samples as 32-bit integers. Defauts to False.
        augmentor (roar.collections.tts.parts.perturb.AudioAugmentor): An AudioAugmentor
...
class AudioToBPEDataset(_AudioTextDataset):
    ...
    Args:
        ...
        tokenizer: A subclass of the Tokenizer wrapper found in the common collection,
            roar.collections.common.tokenizers.TokenizerSpec. ASR Models support a subset of
    ...
    def __init__(
        self,
        manifest_filepath: str,
        tokenizer: "roar.collections.common.tokenizers.TokenizerSpec",
        sample_rate: int,
        int_values: bool = False,
        augmentor: "roar.collections.tts.parts.perturb.AudioAugmentor" = None,
        max_duration: Optional[int] = None,
...
class _TarredAudioToTextDataset(IterableDataset):
    ...
    def __init__(
        ...
        sample_rate: int,
        int_values: bool = False,
        augmentor: Optional["roar.collections.tts.parts.perturb.AudioAugmentor"] = None,
        shuffle_n: int = 0,
        min_duration: Optional[float] = None,
        max_duration: Optional[float] = None,
        trim: bool = False,
