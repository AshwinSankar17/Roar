...
from roar.collections.asr.data import audio_to_audio_dataset
from roar.collections.asr.data.audio_to_text_dataset import (
...
class EncMaskDecAudioToAudioModel(AudioToAudioModel):
    ...
    def setup_training_data(self, train_data_config: Optional[Union[DictConfig, Dict]]):
        ...
        Supported Datasets:
            -   :class:`~roar.collections.asr.data.audio_to_audio.AudioToTargetDataset`
        """
    ...
    def evaluation_step(
        ...
        self.log(
            "global_step",
            torch.tensor(self.trainer.global_step, dtype=torch.float32),
            sync_dist=True,
        )
