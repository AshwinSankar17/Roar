...
from roar.collections.tts.data.dataset import DistributedBucketSampler
from roar.collections.tts.losses.vits_losses import DiscriminatorLoss, FeatureMatchingLoss, GeneratorLoss, KlLoss
from roar.collections.tts.models.base import TextToWaveform
from roar.collections.tts.modules.vits_modules import MultiPeriodDiscriminator
...
from roar.collections.tts.torch.tts_data_types import SpeakerID
...
class VitsModel(TextToWaveform):
    ...
    def _setup_tokenizer(self, cfg):
        ...
        if "g2p" in cfg.text_tokenizer and cfg.text_tokenizer.g2p is not None:
            ...
            if (
                ...
                and cfg.text_tokenizer.g2p["_target_"].startswith("roar_text_processing.g2p")
            ):
    ...
    def list_available_models(cls) -> 'List[PretrainedModelInfo]':
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_en_lj_vits/versions/1.13.0/files/vits_ljspeech_fp16_full.roar",
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_en_hifitts_vits/versions/r1.15.0/files/vits_en_hifitts.roar",
