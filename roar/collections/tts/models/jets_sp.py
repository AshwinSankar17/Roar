...
from roar.collections.tts.modules.jets_sp import JETSModule
...
class JETSPromptModel(TextToWaveform, Exportable):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        prompt_encoder = instantiate(self._cfg.get("prompt_encoder", None))
    ...
    def validation_step(self, batch, batch_idx):
        ...
        mels, mel_lens = self.preprocessor(audio, audio_lens)
         ...
         # get ref_spec
        reference_spec, reference_spec_len = None, None
        reference_spec, _ = rand_slice_segments(mels, mel_lens, segment_size=283)
