...
from roar.collections.tts.models.base import Vocoder
from roar.collections.tts.modules.bigvgan_modules import (
...
class HifiGanModel(Vocoder, Exportable):
    ...
    def __init__(self, cfg: DictConfig, trainer: "Trainer" = None):
        ...
        # self.mrd = MultiScaleDiscriminator(debug=cfg.debug if "debug" in cfg else False)
        # self.mrd = instantiate(cfg.mrd)
        self.mrd = MultiResolutionDiscriminator(
            resolutions=cfg.discriminator_resolutions,
            debug=cfg.debug if "debug" in cfg else False,
        )
    ...
    def configure_optimizers(self):
        ...
        disc_params = itertools.chain(self.mrd.parameters(), self.mpd.parameters())
    ...
    def training_step(self, batch, batch_idx):
        ...
        msd_score_real, msd_score_gen, _, _ = self.mrd(
            y=audio, y_hat=audio_pred.detach()
        )
        ...
        _, msd_score_gen, fmap_msd_real, fmap_msd_gen = self.mrd(
            y=audio, y_hat=audio_pred
        )
    ...
    def _process_batch(self, batch):
        ...
        if self.ds_class == "roar.collections.tts.data.vocoder_dataset.VocoderDataset":
    ...
    def configure_callbacks(self):
        ...
        if (
            sample_ds_class
            != "roar.collections.tts.data.vocoder_dataset.VocoderDataset"
        ):
            raise ValueError(
    ...
    def list_available_models(cls) -> "Optional[Dict[str, str]]":
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_hifigan/versions/1.0.0rc1/files/tts_hifigan.roar",
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_en_lj_hifigan/versions/1.6.0/files/tts_en_lj_hifigan_ft_mixertts.roar",
            description="This model is trained on LJSpeech audio sampled at 22050Hz and mel spectrograms generated from"
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_en_lj_hifigan/versions/1.6.0/files/tts_en_lj_hifigan_ft_mixerttsx.roar",
            description="This model is trained on LJSpeech audio sampled at 22050Hz and mel spectrograms generated from"
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_en_multispeaker_fastpitchhifigan/versions/1.10.0/files/tts_en_hifitts_hifigan_ft_fastpitch.roar",
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_de_fastpitchhifigan/versions/1.15.0/files/tts_de_hifigan_thorstens2102.roar",
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_de_fastpitchhifigan/versions/1.15.0/files/tts_de_hifigan_thorstens2210.roar",
            description="This model is finetuned from the HiFiGAN pretrained checkpoint `tts_en_lj_hifigan_ft_mixerttsx`"
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_de_fastpitch_multispeaker_5/versions/1.11.0/files/tts_de_hui_hifigan_ft_fastpitch_multispeaker_5.roar",
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_es_multispeaker_fastpitchhifigan/versions/1.15.0/files/tts_es_hifigan_ft_fastpitch_multispeaker.roar",
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_zh_fastpitch_hifigan_sfspeech/versions/1.15.0/files/tts_zh_hifigan_sfspeech.roar",
            description="This model is finetuned from the HiFiGAN pretrained checkpoint `tts_en_lj_hifigan_ft_mixerttsx`"
