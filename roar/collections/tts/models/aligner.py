...
class AlignerModel(ModelPT):
    ...
    def _setup_normalizer(self, cfg):
        if "text_normalizer" in cfg:
            ...
            try:
                ...
                logging.error(e)
                raise ImportError(
                    "`nemo_text_processing` not installed, see https://github.com/NVIDIA/roar-text-processing for more details"
                )
    ...
    def training_step(self, batch, batch_idx):
        ...
        train_log = {
            ...
            "train_bin_loss": torch.tensor(1.0).to(forward_sum_loss.device)
            if bin_loss is None
            else bin_loss,
        }
        return {
    ...
    def validation_step(self, batch, batch_idx):
        ...
        val_log = {
            ...
            "val_bin_loss": torch.tensor(1.0).to(forward_sum_loss.device)
            if bin_loss is None
            else bin_loss,
        }
        self.log_dict(
    ...
    def list_available_models(cls) -> List[PretrainedModelInfo]:
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_en_radtts_aligner/versions/ARPABET_1.11.0/files/Aligner.roar",
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_en_radtts_aligner/versions/IPA_1.13.0/files/Aligner.roar",
            description="This model is trained on LJSpeech sampled at 22050Hz with and can be used to align text and audio.",
            class_=cls,
        )
        list_of_models.append(model)
