...
from roar.collections.tts.losses.spectrogram_enhancer_losses import (
    ConsistencyLoss,
    GeneratorLoss,
    GradientPenaltyLoss,
    HingeLoss,
...
from roar.core import Exportable, ModelPT, PretrainedModelInfo, typecheck
from roar.core.neural_types import LengthsType, MelSpectrogramType, NeuralType
from roar.core.neural_types.elements import BoolType
...
class SpectrogramEnhancerModel(ModelPT, Exportable):
    ...
    def list_available_models(cls):
        ...
        model = PretrainedModelInfo(
            ...
            location="https://api.ngc.nvidia.com/v2/models/nvidia/roar/tts_en_fastpitch_spectrogram_enhancer_for_asr_finetuning/versions/1.20.0/files/tts_en_spectrogram_enhancer_for_asr_finetuning.roar",
