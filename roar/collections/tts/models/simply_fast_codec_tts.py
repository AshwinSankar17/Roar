...
# from roar.collections.tts.losses.hifigan_losses import MelLoss

from roar.collections.tts.models.base import SpectrogramGenerator
from roar.collections.tts.modules.simply_fast_codec_tts import SimplyFastCodecModule
...
class SimplyFastCodecTTS(SpectrogramGenerator, Exportable, FastPitchAdapterModelMixin):
    """Yet to be published. Only works at 24Khz for now"""
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        if self.learn_alignment:
            ...
            if not self.ds_class in [
                ...
                "roar.collections.tts.data.dataset_new.TTSDataset",
        ...
        # self.codec_processor = CodecPreprocessor("facebook/encodec_24khz")
        ...
        self.fastpitch = SimplyFastCodecModule(
            input_fft,
            output_fft,
            duration_predictor,
            pitch_predictor,
    ...
    def training_step(self, batch, batch_idx):
        ...
        #TODO: pass codec_latents and lens if want to align with those instead. There should be no big difference tho.
        (
            mels_pred,
            _,
            _,
            ...
            speaker=speaker,
            pace=1.0,
            spec=mels if self.learn_alignment else None,  #TODO: Change back to mel if needed
            reference_spec=reference_spec,
        ...
        # codec_latents = torch.log(codec_latents + 30)
        ...
        self.log("t_codec_loss", mel_loss)
    ...
    def on_validation_epoch_end(self):
        ...
        mel_loss = collect("codec_loss")
        dur_loss = collect("dur_loss")
        pitch_loss = collect("pitch_loss")
        self.log("val_loss", val_loss, sync_dist=True)
        self.log("val_codec_loss", mel_loss, sync_dist=True)
    ...
    def __setup_dataloader_from_config(
        ...
        if any(self.ds_class == x for x in [
            "roar.collections.tts.data.dataset.TTSDataset",
            "roar.collections.tts.data.dataset_new.TTSDataset"
            ]):
            phon_mode = contextlib.nullcontext()
