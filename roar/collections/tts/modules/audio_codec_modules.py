...
from roar.collections.asr.modules import AudioToMelSpectrogramPreprocessor
from roar.collections.tts.modules.submodules import ConvNorm, ConvTransposeNorm
from roar.collections.tts.parts.utils.activations import Snake
...
class FiniteScalarQuantizer(VectorQuantizerBase):
    ...
    def decode(
        self, indices: torch.Tensor, input_len: Optional[torch.Tensor] = None
    ) -> torch.Tensor:
