...
def add_asr_args(parent_parser: ArgumentParser) -> ArgumentParser:
    ...
    Returns:
        ArgumentParser: Parser extended by Roar ASR Collection arguments.
    """
    parser = ArgumentParser(parents=[parent_parser], add_help=False, conflict_handler='resolve')
...
def add_nlp_args(parent_parser: ArgumentParser) -> ArgumentParser:
    ...
    Returns:
        ArgumentParser: Parser extended by Roar NLP Collection arguments.
    """
    parser = ArgumentParser(parents=[parent_parser], add_help=False, conflict_handler='resolve')
    parser.add_argument(
    ...
    parser.add_argument(
        "--tokenizer_name", default='roarbert', type=str, choices=['sentencepiece', 'roarbert'], help="Tokenizer type"
    )
