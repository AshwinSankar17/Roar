...
from roar.utils import CastToFloat, CastToFloatAll, logging
...
def replace_MatchedScaleMaskSoftmax(n: nn.Module) -> Optional[nn.Linear]:
    ...
    from roar.collections.nlp.modules.common.megatron.fused_softmax import MatchedScaleMaskSoftmax
...
def replace_for_export(model: nn.Module) -> nn.Module:
    ...
    Returns:
        model, possibly modified in-place
    """
    from roar.collections.tts.modules.submodules import MaskedInstanceNorm1d
