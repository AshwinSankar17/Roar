...
class AppState(metaclass=Singleton):
    ...
    @property
    def roar_file_folder(self) -> str:
        return self._roar_file_folder

    @roar_file_folder.setter
    def roar_file_folder(self, path: str):
        self._roar_file_folder = path
