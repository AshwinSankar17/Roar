...
def add_memory_handlers_to_pl_logger():
    ...
    function is called in roar.utils.__init__.py. These handlers are used in add_filehandlers_to_pl_logger to flush
...
def add_filehandlers_to_pl_logger(all_log_file, err_log_file):
    """
    Adds two filehandlers to pytorch_lightning's logger. Called in roar.utils.exp_manager(). The first filehandler
